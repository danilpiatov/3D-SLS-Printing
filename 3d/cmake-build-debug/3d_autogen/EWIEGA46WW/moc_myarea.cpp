...
struct qt_meta_stringdata_MyArea_t {
    QByteArrayData data[1];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyArea_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyArea_t qt_meta_stringdata_MyArea = {
    {
QT_MOC_LITERAL(0, 0, 6) // "MyArea"
...
QT_INIT_METAOBJECT const QMetaObject MyArea::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_MyArea.data,
    qt_meta_data_MyArea,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *MyArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyArea.stringdata0))
